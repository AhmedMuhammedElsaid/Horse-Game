...
var gameAction = function gameAction(gameType) {
  return function (dispatch) {
    fetch("https://www.atg.se/services/racinginfo/v1/api/products/".concat(gameType)).then(function (res) {
      var data = res.json();
      return data;
    }).then(function (data) {
      ...
      fetch(" https://www.atg.se/services/racinginfo/v1/api/games/".concat(closest)).then(function (res) {
